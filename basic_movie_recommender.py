...
class BasicMovieRecommender:
    """
    A basic movie recommendation system using content-based filtering.
    """
    ...
    def create_dataset(self):
        """
        Create a basic dataset with movies.
        """
        data = {
            'title': [
...
def main():
    ...
    recommender = BasicMovieRecommender()
